  ...
  drawLectures(){
    ...
    var aiff = <div className="singleLectureContainer">
      <div className="singleWebsiteCard">
         <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/hslee/src/images/membership/aiff.jpg" alt="projectimage"/>
    ...
    var membership1 = <div className="singleLectureContainer">
      <div className="singleWebsiteCard">
         <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/hslee/src/images/membership/1.jpg" alt="projectimage"/>
        <div className="projectText">
    ...
    var membership2 = <div className="singleLectureContainer">
      <div className="singleWebsiteCard">
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/hslee/src/images/membership/2.jpg" alt="projectimage"/>
        <div className="projectText">
    ...
    var membership3 = <div className="singleLectureContainer">
      <div className="singleWebsiteCard">
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/hslee/src/images/membership/3.jpg" alt="projectimage"/>
        <div className="projectText">
    ...
    var membership4 = <div className="singleLectureContainer">
      <div className="singleWebsiteCard">
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/hslee/src/images/membership/4.jpg" alt="projectimage"/>
        <div className="projectText">
          <p><h5>Intertel</h5></p>
            <p className="bookDescription">
    ...
    <div className="singleWebsiteCard">
      <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/hslee/src/images/membership/5.jpg" alt="projectimage"/>
      <div className="projectText">
    ...
    <div className="singleWebsiteCard">
      <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/hslee/src/images/membership/6.jpg" alt="projectimage"/>
      <div className="projectText">
    ...
    var cheesecake = <div className="singleLectureContainer">
      <div className="singleWebsiteCard">
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/hslee/src/images/membership/cheesecake.jpg" alt="projectimage"/>
        <div className="projectText">
    ...
    var jihak = <div className="singleLectureContainer">
      <div className="singleWebsiteCard">
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/hslee/src/images/membership/jihak.png" alt="projectimage"/>
        <div className="projectText">
          <p><h5>고교독서평설</h5></p>
            <p className="bookDescription">
